    ...
    <>
      ...
      <nav className="hidden w-full lg:block pt-5 pb-5 shadow-lg">
        <div className="nav-bar md:mr-10 md:ml-10 flex flex-row justify-between">
          ...
          <div className="nav-links flex flex-row">
            ...
            <a href="" className="mr-8">
              <img src="src\assets\images\discord.png" alt="" width="30px" />
            </a>
            <a href="" className="mr-8">
              <img src="src\assets\images\man.png" alt="" width="30px" />
            </a>
          </div>
        </div>
      </nav>
      ...
      <div className="relative mt-2">
        ...
        >
          ...
          <div>
            <img
              src="src\assets\images\Group 1410097012.png"
              width="20px"
              alt=""
            />
          </div>
          <div className="ml-2 text-normal font-bold text-white">Module - 1</div>
          </div>
          ...
          <nav id="sidebar1">
            ...
            <ul class="list-items pl-6 pt-16 pr-4">
              <li>
                <a href="#" className="text-gray-200 hover:text-white transition duration-200 ease-in-out">
                  Introduction to OS & Networks
                </a>
              </li>
              <li>
                <a href="#" className="text-gray-200 hover:text-white transition duration-200 ease-in-out">Working with Command Line</a>
              </li>
              <li>
                <a href="#" className="text-gray-200 hover:text-white transition duration-200 ease-in-out">Collaborating with Git</a>
              </li>
              <li>
                <a href="#" className="text-gray-200 hover:text-white transition duration-200 ease-in-out">Overview of OS Concepts</a>
              </li>
              <li>
                <a href="#" className="text-gray-200 hover:text-white transition duration-200 ease-in-out">Files & File System</a>
              </li>
              <li>
                <a href="#" className="text-gray-200 hover:text-white transition duration-200 ease-in-out">VCS & Git Repositories</a>
              </li>
            </ul>
          </nav>
        </div>
      </div>
      <div className="dash-board flex md:flex-row">
        {/* LMS sidebar Start */}
          ...
          <div className="left-side ml-8 mr-4 mt-10 mb-8">
            <div className="ml-4 mt-4">
              ...
              <div className="mt-8 mb-8">
                ...
                >
                  ...
                  <span className="font-medium text-lg ml-2">Playground</span>
                </a>
              </div>
              <div className="mt-8 mb-8">
                <a
            ...
            <div className="ml-4">
              <div className="mt-4 md:mt-0 -ml-10 pt-2 pb-2">
                <a href="">
                  <img
                    src="src\assets\images\Group 1410097013.png"
                    alt=""
                    width="280px"
                    height="230px"
                  />
        ...
        {/* <div className="wrapper1 relative mt-4">
          <input type="checkbox" id="btn1" hidden />
          <label class="menu-btn1"></label>
          <nav id="sidebar1">
            <div className="title items-center text-2xl font-bold h-10 mt-3 mb-6">
              Module - 1
            </div>
            <ul class="list-items pl-6">
              <li>
        ...
        <div className="right-side flex flex-row justify-between w-full lg:w-3/4 xl:w-4/5 mr-4 lg:mr-8 ml-4 mt-6 md:mt-10 mb-8">
          <div className="pt-4 pb-4 pl-4 pr-4 md:pt-8 md:pb-8 md:order-2 lg:order-1 md:pl-10 md:pr-10">
            ...
            <div className="mt-6">
              <a href="">
                <img
                  src="src\assets\images\video-frame.png"
                  alt=""
                  className=""
                />
              </a>
          ...
          <div className="right-side-inner hidden md:flex md:order-1 lg:order-2 md:w-1/2 lg:w-1/2 xl:w-1/4">
            <div className="ml-4 mt-4">
              <div className="mt-8 mb-8">
                ...
                >
                  <span className="font-bold ml-2 text-xl">Module-1</span>
                </a>
              </div>
              <div className="mt-8 mb-8">
                <a
